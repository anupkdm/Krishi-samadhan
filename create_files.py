...
base_dir = r"C:\Users\anupk\.gemini\antigravity\scratch\agri-samadhan\frontend\src"
...
files["config/locations.js"] = """export const DEFAULT_LOCATION = {
  name: 'My Locality',
  latitude: 19.8833,
  longitude: 74.4833
};
...
files["index.css"] = """@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
...
files["components/Navbar.jsx"] = """import React, { useState } from 'react';
...
files["components/DashboardSidebar.jsx"] = """import React from 'react';
...
files["components/DashboardLayout.jsx"] = """import React, { useState } from 'react';
...
files["components/MetricCard.jsx"] = """import React from 'react';
...
files["components/AlertCard.jsx"] = """import React from 'react';
...
files["components/DataTable.jsx"] = """import React from 'react';
...
files["components/LoadingState.jsx"] = """import React from 'react';
...
files["components/ErrorState.jsx"] = """import React from 'react';
...
files["components/EmptyState.jsx"] = """import React from 'react';
...
files["components/SourceBadge.jsx"] = """import React from 'react';
...
files["components/Footer.jsx"] = """import React from 'react';
...
files["services/api.js"] = """import { API_BASE_URL } from '../config/locations';
...
files["services/authService.js"] = """import api from './api';
...
files["services/weatherService.js"] = """import api from './api';
...
files["services/marketService.js"] = """import api from './api';
...
files["services/soilService.js"] = """import api from './api';

export const getSoilData = (lat, lon) => api.get('/soil', { lat, lon });
"""

files["services/satelliteService.js"] = """import api from './api';

export const getSatelliteData = (lat, lon) => api.get('/satellite', { lat, lon });
"""

files["services/pestService.js"] = """import api from './api';
